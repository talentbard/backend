...
class TalentRegistrationCreateView(APIView):
        ...
        request_body=openapi.Schema(
            ...
            properties={
                ...
                "payload": openapi.Schema(
                    ...
                    required=["user_id", "full_name", "email_id","phone_no","linkedin","current_location","preferred_location" "freelancer_status", "availability"],
                ),
            },
    ...
    def post(self, request):
        ...
        if not full_name or not email_id or not freelancer_status or not availability or not phone_no or not linkedin or not current_location or not preferred_location:
            return Response(
                {"error": "Full Name, Email, Phone number, Linkedin, Current or Preffered Location, Freelancer Status, and Availability are required."},
        ...
        if serializer.is_valid():
            ...
            user_data = {
                ...
                "user_id": str(talent_registration.user_id),
            }
